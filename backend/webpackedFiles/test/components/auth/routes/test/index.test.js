...
var _nock = __webpack_require__(66);

var _nock2 = _interopRequireDefault(_nock);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _nock2.default)('https://github.com').post('/login/oauth/access_token').reply(200, {
  access_token: 111111
});

(0, _nock2.default)('https://api.github.com').get('/user').reply(200, {
  login: "octocat",
  id: 1,
...
(0, _nock2.default)('https://www.googleapis.com').post('/oauth2/v4/token').reply(200, {
...
(0, _nock2.default)('https://www.googleapis.com').get('/userinfo/v2/me').reply(200, {
...
describe('/api/auth', function () {
  beforeEach('truncating db', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', _init.db.none('TRUNCATE TABLE "user" RESTART IDENTITY CASCADE'));
  ...
  it('/github/callback - created a new user', function (done) {
    (0, _supertest2.default)(_routes.routes).get('/api/auth/github/callback').query({
      code: '74832748932748923789'
    }).expect(302).end(function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(error, response) {
        var createdUser;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                (0, _chai.expect)(response.header['location']).to.include('/?token=');

                _context2.next = 3;
                return User.select.one(1);

              case 3:
                createdUser = _context2.sent;

                (0, _chai.expect)(createdUser).to.deep.include({
                  id: 1,
                  username: 'octocat',
                  email: 'octocat@github.com',
                  oauthProvider: 'github',
  ...
  it('/google/callback - created a new user', function (done) {
    (0, _supertest2.default)(_routes.routes).get('/api/auth/google/callback').query({
      code: '748327489327489266689'
    }).expect(302).end(function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(error, response) {
        var createdUser;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
