...
var CourseUserIsLearning = _interopRequireWildcard(_index);

var _model = __webpack_require__(9);

var ProblemUserIsLearning = _interopRequireWildcard(_model);
...
describe('coursesUserIsLearning:model:select', function () {
  describe('idsOfProblemsToLearnAndReviewPerCourse', function () {
    beforeEach('truncating db', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt('return', _init.db.none('TRUNCATE TABLE problem, course, "user", problem_user_is_learning, course_user_is_learning RESTART IDENTITY CASCADE'));
    ...
    it('=> {} for new users', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      var user, result;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _Factory.RawFactory.user({});

            case 2:
              user = _context2.sent;
              result = CourseUserIsLearning.select.idsOfProblemsToLearnAndReviewPerCourse(user.id);
    ...
    it('=> toLearn: [problemId] after user starts learning a course', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
      var user, course, problem, result;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              user = _context3.sent;
              _context3.next = 5;
              return _Factory.Factory.course({});

            case 5:
              course = _context3.sent;
              _context3.next = 8;
              return _Factory.RawFactory.problem({ courseId: course.id });

            case 8:
              problem = _context3.sent;
              _context3.next = 11;
              return _Factory.RawFactory.courseUserIsLearning({
                courseId: course.id,
                userId: user.id,
                active: true
              });
            ...
            case 11:
              _context3.next = 13;
              return CourseUserIsLearning.select.idsOfProblemsToLearnAndReviewPerCourse(user.id);

            case 13:
              result = _context3.sent;

              (0, _chai.expect)(result).to.deep.equal(_defineProperty({}, course.id, { toLearn: [problem.id], toReview: [] }));
    ...
    it('=> toReview: [problemId] after user learned a problem', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
      var user, course, problem_1, problem_2, cuil, result;
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 8:
              problem_1 = _context4.sent;
              _context4.next = 11;
              return _Factory.RawFactory.problem({ courseId: course.id });

            case 11:
              problem_2 = _context4.sent;
              _context4.next = 14;
              return _Factory.RawFactory.courseUserIsLearning({
                courseId: course.id,
                userId: user.id,
            ...
            case 19:
              ...
              (0, _chai.expect)(result).to.deep.equal(_defineProperty({}, course.id, { toLearn: [problem_2.id], toReview: [problem_1.id] }));
    ...
    it('=> toLearn: [] for course with no problems', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 10:
              ...
              (0, _chai.expect)(result).to.deep.equal(_defineProperty({}, course.id, { toLearn: [], toReview: [] }));
    ...
    it('=> toReview, toLearn: [no ignored problemId] if user ignores a problem', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
      var user, course, problem_1, problem_2, problem_3, cuil, result;
      return regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 8:
              problem_1 = _context6.sent;
              _context6.next = 11;
              return _Factory.RawFactory.problem({ courseId: course.id });

            case 11:
              problem_2 = _context6.sent;
              _context6.next = 14;
              return _Factory.RawFactory.problem({ courseId: course.id });

            case 14:
              problem_3 = _context6.sent;
              _context6.next = 17;
              return _Factory.RawFactory.courseUserIsLearning({
                courseId: course.id,
                userId: user.id,
            ...
            case 17:
              cuil = _context6.sent;
              _context6.next = 20;
              return _Factory.RawFactory.problemUserIsLearning({ courseUserIsLearningId: cuil.id, problemId: problem_1.id, ifIgnored: true });

            case 20:
              _context6.next = 22;
              return _Factory.RawFactory.problemUserIsLearning({ courseUserIsLearningId: cuil.id, problemId: problem_2.id });
            ...
            case 24:
              ...
              (0, _chai.expect)(result).to.deep.equal(_defineProperty({}, course.id, { toLearn: [problem_3.id], toReview: [problem_2.id] }));
