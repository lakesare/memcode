        ...
        <div className="container">
...

          {
            ...
            <section className="article-section">
              ...
              Knowledge retention rates have been incomparable to classical study methods, so it's been a great experience overall.<br/>
...

              {
                ...
                <div className="how-did-I-choose-sites-for-comparison">
                  ...
                  <ul>
                    <li><b>It has to be web-based.</b> That's why I didn't include Anki (only desktop), or Flashcards Deluxe (only mobile). I consider browser to be the most comfortable environment.</li>
